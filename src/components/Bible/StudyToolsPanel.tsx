...
const styles = StyleSheet.create({
  ...
  resultCard: { width: 190, borderWidth: 1, borderRadius: 12, padding: 10 },
  selectedBox: { borderWidth: 1, borderRadius: 12, padding: 12, marginTop: 12, gap: 8 },
  ...
  translationChip: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 12 },
  toolCard: { borderWidth: 1, borderRadius: 12, padding: 12, width: '47%' },
});
